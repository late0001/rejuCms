...
<script type="text/javascript">uaredirect("<?php echo $rjcms_domain;?>wap/user.php");</script>

<?php	 } ?>
<header class="navbar">		
		<div class="container">			
			<div class="clearfix navbar-top">				
				<a href="<?php echo $rjcms_domain;?>"><img src="<?php echo $rjcms_domain.$rjcms_logo;?>" class="pull-left logo-left"></a>				
				...
				<form class="navbar-form hidden-xs" role="search" action="<?php echo $rjcms_domain;?>seacher.php" method="post">					
				...
				<a class="pull-right hidden-xs">					
					...
					<span class="telephone"><img src="<?php echo $rjcms_weixin;?>"></span>			
				</a>			
			...
			<div class="container">				
				<div class="navbar-header">					
					<ul class="nav navbar-left navbar-collapse collapse">						
						<li class=""><a href="<?php echo $rjcms_domain;?>" class="">首页 </a></li>						
