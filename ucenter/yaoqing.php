...
<div class="form-group">
									<label class="col-md-12 control-label" for="name">我的推广链接：<?php echo $rjcms_domain;?>ucenter/reg.php?tg=<?php echo $u_id ?></label>
...
<p>我不想邀请，直接购买充值卡充值：<a href="<?php echo $rjcms_qqun;?>" target="_blank">点此购买>>></a></p>
            		</div>
