...
// 检测用户名是否存在
$query = mysqli_query($conn, "select u_id from rjcms_user where u_name='$username' and u_email='$email'");
if(!! $row = mysqli_fetch_array($query)){
$_data['u_password'] = md5(123456);
$sql = 'update rjcms_user set '.arrtoupdate($_data).' where u_name="'.$username.'"';
...
include("emailconfig.php");
    ...
    $email = $email;  //收件人邮箱
    $emailTitle = "".$rjcms_name."用户找回密码"; //邮件主题
    $emailBody = "亲爱的".$username."：<br/>感谢您在我站注册帐号。<br/>您的初始密码为123456<br/>如果此次找回密码请求非你本人所发，请忽略本邮件。<br/><p style='text-align:right'>-------- ".$rjcms_name." 敬上</p>";
...
<title>找回密码-<?php echo $rjcms_seoname;?></title>
