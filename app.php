...
<head>
    <meta charset='utf-8' />
    <title><?php echo $rjcms_seoname;?>app下载</title> 
...
<div id="doc">
    <div id="cover">
        <div class="topbar">
            <div id="logo">
                <a href="<?php echo $rjcms_domain;?>">
                    <img src="<?php echo $rjcms_logo;?>">
                </a>
            </div>
        </div>
        <div class="header g-clear">
            <div class="phone">
                <img src="<?php echo $rjcms_apppic;?>">
            </div>
            <div class="desc">
                <h1 >
                    <img src="<?php echo $rjcms_appbt;?>" alt="影视大全。下载神器，畅看大片！">
                </h1>
                <div class="download clearfix">
                    <div class="down-btns">
                        <a href="" class="btn btn-iphone"></a>
                        <a href="<?php echo $rjcms_appurl;?>" class="btn btn-android"></a>
                    </div>
                    <div class="down-qr">
                        <img src="<?php echo $rjcms_appewm;?>">
                        <p >二维码扫描下载</p>
                    </div>
                </div>
            </div>
