...
<section class="tuijian_box">
  <h2 class="clearfix tuijian bgfff" ><em class="dianyin"></em>抢先看<a class="fr more" href="vlist.php?cid=0">更多<em class="more_icon"></em></a></h2>
  <div class="dianying_box  bgfff clearfix">
    <ul class="clearfix">      
      <?php $result = mysqli_query($conn, 'select * from rjcms_vod where d_rec=1 order by d_id desc LIMIT 0,6');
		while ($row = mysqli_fetch_array($result)){
$cc="./bplay.php?play=";
								$dd="./bplay/";
if ($rjcms_wei==1){
