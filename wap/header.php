<section class="logo_box clearfix">
  <div class="fl"> <a href="<?php echo $rjcms_domain;?>/wap/"><img class="logo_img" src="<?php echo $rjcms_logo;?>"></a> </div>
  <div class="sosuo_box fl">
    <form  action="<?php echo $rjcms_domain;?>wap/seacher.php" method="post" role="form">
...
<li><a href="<?php echo $rjcms_domain;?>wap/">首页</a></li>
					<?php if($rjcms_dianying==1){?><li <?php echo $movie;?>><a href="<?php echo $rjcms_domain;?>wap/movie.php">电影</a></li><?php }?>
					<?php if($rjcms_dianshi==1){?><li <?php echo $tv;?>><a href="<?php echo $rjcms_domain;?>wap/tv.php">电视剧</a></li><?php }?>
					<?php if($rjcms_dongman==1){?><li <?php echo $dm;?>><a href="<?php echo $rjcms_domain;?>wap/dongman.php">动漫</a></li><?php }?>
					<?php if($rjcms_zongyi==1){?><li <?php echo $zy;?>><a href="<?php echo $rjcms_domain;?>wap/zongyi.php">综艺</a></li><?php }?>
...
<a class="jishu fl guanzhu" style="background: none;color: #fff;font-weight:bold;text-aligin：center"><?php echo $rjcms_tixing;?></a>
...
<section class="gonggao_box clearfix">
  <div class="gonggao_box2 clearfix"> <span class="gonggao fl">公告</span>
      ...
      <div id="gongao" class="fl xianshi" style="width: 82%;height: 27px"> 
        ...
        <div id="scroll_begin"> 
         <a class="guanzhu" href="" style="background: none;color: #000"><?php echo $rjcms_gonggao?></a>
        </div> 
        <div id="scroll_end">  
         <a class="guanzhu" href="" style="background: none;color: #000"><?php echo $rjcms_gonggao?></a>
        </div> 
