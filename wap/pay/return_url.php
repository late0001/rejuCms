...
$order = mysqli_query($conn, 'select * from rjcms_user_pay where p_order="'.$out_trade_no.'"');
if($row1 = mysqli_fetch_array($order)){
...
$sql1 = 'update rjcms_user_pay set p_status=1 where p_order="'.$out_trade_no.'"';
