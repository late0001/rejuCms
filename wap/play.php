...
<title><?php echo $timu; ?>-正在播放-<?php echo $rjcms_seoname;?></title>
<meta name="keywords" content="<?php echo $timu; ?>,<?php echo $rjcms_keywords;?>">
<meta name="description" content="<?php echo $timu; ?>,<?php echo $rjcms_description;?>">
<style type="text/css">
