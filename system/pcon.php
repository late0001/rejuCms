...
<script type="text/javascript">uaredirect("<?php echo $rjcms_domain;?>wap/<?php echo $tiaourl;?>");</script>
...
?>
	...
	<div class="weixin-tip">
		<p>
			<img src="<?php echo $rjcms_domain;?>images/live_weixin.png" width=100% alt="微信打开"/>
		</p>
	</div>
