...
function channel_select_list($_var_0, $_var_1, $_var_2, $_var_3)
{
	...
	$_var_7 = $_var_0 == 0 ? '' : '├';
	$_var_6 = $_var_6 + 1;
	$_var_9 = 'select * from rjcms_vod_class where c_pid = ' . $_var_0 . ' and c_id <> ' . $_var_3 . ' order by c_sort asc , c_id asc';
...
{
	$_var_15 = $_var_14;
	$_var_16 = 'select * from rjcms_vod_class where c_id =' . $_var_13 . '';
...
{
	$_var_31 = mysqli_query($conn, 'select * from cms_channel where c_parent = ' . $_var_30 . ' ');
...
function channel_manage($_var_32, $_var_33)
{
	...
	$_var_35 = $_var_33;
	$_var_36 = '';
	$_var_37 = mysqli_query($conn, 'select * from rjcms_vod_class where c_pid= ' . $_var_32 . ' order by c_sort asc , c_id asc ');
...
{
	$_var_42 = mysqli_query($conn, 'select * from rjcms_vod_class where c_id=' . $_var_41 . '');
...
{
	$_var_45 = mysqli_query($conn, 'select * from rjcms_user_group where ug_id=' . $_var_44 . '');
...
{
	$_var_48 = mysqli_query($conn, 'select * from rjcms_vod where d_id =' . $_var_47 . '');
...
{
	$_var_51 = mysqli_query($conn, 'select * from rjcms_vod where d_id =' . $_var_50 . '');
...
{
	$_var_56 = mysqli_query($conn, 'select * from rjcms_vod where d_id =' . $_var_55 . '');
