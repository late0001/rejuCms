...
$dm='class="active"'?>
<title>动漫列表-<?php echo $rjcms_seoname;?></title>
<meta name="keywords" content="动漫排行,<?php echo $rjcms_keywords;?>">
...
$flname= $dmname[$kcat]; 
$flid="?m=/dongman/list.php?cat=".$vcat.'&page=1'; 
echo "<a href='$flid' class='acat' style='white-space: pre-wrap;margin-bottom: 4px;'>$flname</a>"; } 
?></dd>
      </dl>
      <dl class="cleafix">
...
echo "<a class='acat' style='white-space: pre-wrap;margin-bottom: 4px;' href='?m=$flid' target='_self'>$flname</a>";}?></dd>
      </dl>
