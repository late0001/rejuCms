    ...
    var t = setTimeout(adsUp,<?php echo $rjcms_miaoshu*1000;?>); 
					...
					<div class="footer clearfix">
						...
						<ul class="cleafix hidden-sm hidden-xs">
									...
									<li><a class="btn btn-sm btn-default" href="<?php echo $rjcms_domain;?>addfav.php?title=<?php echo $timu; ?>&dizhi=<?php echo 'http://'.$_SERVER['HTTP_HOST'].$_SERVER['PHP_SELF'].'?'.$_SERVER['QUERY_STRING'];?>"> <i class="icon iconfont icon-collection"></i> 收 藏</a></li>
...
<div><marquee direction="left"><?php echo $rjcms_gonggao?></marquee></div>								
<?php
if (empty($panduan) && empty($panduan1)) {
